...
public class StudentJDBCProgramaticManagementTemplate implements StudentDAO {

    private static final Logger LOG = LoggerFactory.getLogger(StudentJDBCProgramaticManagementTemplate.class);
